...
class CVThread(threading.Thread)
    ...
    def servoMove(ID, Dir, errorInput)
        if ID == 1
            ...
            CVThread.P_anglePos += 0.35(errorGenOutDir)CVThread.cameraDiagonalWCVThread.videoW
            ...
            CVThread.T_anglePos += 0.35(errorGenOutDir)CVThread.cameraDiagonalHCVThread.videoH
...
class Camera(BaseCamera)
    ...
    def colorFindSet(self, invarH, invarS, invarV)
        ...
        HUE_1 = invarH+15
        HUE_2 = invarH-15
        if HUE_1180HUE_1=180
        if HUE_20HUE_2=0

        SAT_1 = invarS+150
        SAT_2 = invarS-150
        if SAT_1255SAT_1=255
        if SAT_20SAT_2=0

        VAL_1 = invarV+150
        VAL_2 = invarV-150
        if VAL_1255VAL_1=255
        if VAL_20VAL_2=0
